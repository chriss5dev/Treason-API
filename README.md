...
- "Enables the 'carend.wav' sound that plays at the end of carnage rounds if not set to 0. This has minor visual downsides, such as the winner name being '[REDACTED]'. To remedy this, the winner is placed in chat."
